...
version: alpha
name: Stripe
description: Payment infrastructure. Signature purple anchor, weight-300 elegance, blue-tinted depth.

colors:
  primary: "#533afd"          # Stripe Purple — CTA, links, brand anchor
  secondary: "#061b31"        # Deep Navy — headings, premium financial-grade text
  tertiary: "#ea2261"         # Ruby — accent decorative, alerts
  neutral: "#64748d"          # Slate — body text, captions
  surface: "#ffffff"          # Pure White — page background, card fill
  on-surface: "#061b31"       # Heading on light surface
  brand-dark: "#1c1e54"       # Brand Dark — immersive dark sections, footer
  border: "#e5edf5"           # Border Default — cards, dividers
  success: "#15be53"          # Success Green — status badges
  magenta: "#f96bee"          # Magenta — gradient/decorative
...
# 30x-image extension: 数值化品牌参数（taste-skill 借鉴）
taste:
  variance: 4              # 1=symmetric / 10=asymmetric — Stripe 偏对称、可预测
  density: 5               # 1=airy / 10=dense — 平衡
  art_direction: 6         # 1=safe commercial / 10=bold creative — 高级但克制
  spacing: 7               # 1=tight / 10=generous — 慷慨留白
  imagery_realism: 7       # 1=illustration / 10=photoreal — 编辑摄影质感
  text_density_in_image: 4 # 1=clean / 10=info-dense — 文案精炼
---
...
Output: 4 candidates exploring different axis combinations.
```

### For: 30x-image generate logo / slide / product-mockup / marketing-with-text / lighting-transform / scene-with-person
